...
M.lsp = function(event)
  ...
  vim.keymap.set("n", "gd", function()
      Snacks.picker.lsp_definitions({ layout = { preset = "ivy_split", layout = { height = 0.2 } } })
    end,
    { buffer = event.buf, desc = "lsp: [g]oto [d]efinition", silent = true })
  vim.keymap.set("n", "gr", function()
      Snacks.picker.lsp_references({ layout = { preset = "ivy_split", layout = { height = 0.2 } } })
    end,
    { buffer = event.buf, desc = "lsp: [g]oto [r]eferences", silent = true })
  vim.keymap.set("n", "<leader>li", function()
      Snacks.picker.lsp_implementations({ layout = { preset = "ivy_split", layout = { height = 0.2 } } })
    end,
    { buffer = event.buf, desc = "[l]sp: goto [i]mplementation", silent = true })
  vim.keymap.set("n", "<leader>lt", function()
      Snacks.picker.lsp_type_definitions({ layout = { preset = "ivy_split", layout = { height = 0.2 } } })
    end,
  ...
  vim.keymap.set("n", "<leader>ld", function()
    Snacks.picker.lsp_declarations({ layout = { preset = "ivy_split", layout = { height = 0.2 } } })
